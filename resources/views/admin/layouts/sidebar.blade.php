    ...
    <div class="d-flex align-items-center logo_nav">
        ...
        <a class="navbar-brand" href="/dashboard">
            <div class="d-flex align-items-center ">
                <img class="me-2" src="/assets/images/logo.png" alt="" width="40" />
                <span class="font-sans-serif text-primary" style="font-size:12px;"></span>
            </div>
        </a>
    </div>
    <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
        <div class="navbar-vertical-content scrollbar">
            {{-- <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li>
                    <a class="nav-link {{ request()->is('users') ? 'active' : '' }} || {{ request()->is('add-user') ? 'active' : '' }} || {{ request()->is('edit-user/*') ? 'active' : '' }}"
                        href="" role="button">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                ...
                <li>
                    <a class="nav-link {{ request()->is('risk-register') ? 'active' : '' }} || {{ request()->is('view-risk-register/*') ? 'active' : '' }} || {{ request()->is('add-risk') ? 'active' : '' }} || {{ request()->is('edit-risk/*') ? 'active' : '' }}"
                        href="" role="button">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                ...
                <li>
                    <a class="nav-link {{ request()->is('users') ? 'active' : '' }} || {{ request()->is('add-user') ? 'active' : '' }} || {{ request()->is('edit-user/*') ? 'active' : '' }}"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span class="nav-link-text ps-1">Enquiry</span>
                        </div>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a class="nav-link {{ request()->is('users') ? 'active' : '' }} || {{ request()->is('add-user') ? 'active' : '' }} || {{ request()->is('edit-user/*') ? 'active' : '' }}"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span class="nav-link-text ps-1">Client Reviews</span>
                        </div>
                    </a>
                </li>

                <li>
                    <a class="nav-link {{ request()->is('division-master') ? 'active' : '' }} || {{ request()->is('add-division') || request()->is('add-division/*') ? 'active' : '' }} || {{ request()->is('edit-division/*') ? 'active' : '' }} ? 'active' : '' }}"
                        href="" role="button">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                                <span class="bi-stack"></span>
                            </span>
                            <span class="nav-link-text ps-1">CSM</span>
                        </div>
                    </a>
                </li>
            ...
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                @foreach ($menus as $menu)
                    @if (count($menu['children']) > 0)
                        <li>
                            <a class="nav-link dropdown-indicator" href="#menu-{{ $menu['id'] }}" role="button"
                            ...
                            <ul class="nav collapse" id="menu-{{ $menu['id'] }}">
                                @foreach ($menu['children'] as $child)
                                    <li>
                                        <a class="nav-link {{ request()->is($child->route_name) ? 'active' : '' }}"
                    ...
                    @else
                        <li>
                            <a class="nav-link {{ request()->is($menu['route_name']) ? 'active' : '' }}"
                                href="{{ url($menu['route_name']) }}" role="button">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon">
                                        <span class="{{ $menu['icon_class'] }}"></span>
                                    </span>
    ...
    <div class="d-flex align-items-center">
        ...
        <a class="navbar-brand" href="/dashboard">
            <div class="d-flex align-items-center py-3">
                <img class="me-2" src="/assets/images/fabicon.ico" alt="" width="60" />
            </div>
        </a>
    </div>
...
<div class="content">
    <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand" style="display: none;">
        ...
        <a class="navbar-brand me-1 me-sm-3" href="{{ route('dashboard') }}">
            <div class="d-flex align-items-center">
                <img class="me-2 rounded rounded-pill" src="/assets/images/fabicon.ico" alt=""
                    width="40" /><span class="font-sans-serif text-primary"></span>
            </div>
        </a>
        <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
            <span class="text-600" style="font-size:14px;">{{ auth()->user()->name }} <p class="text-400"
                    style="font-size: 12px; margin-bottom: 0px;">{{ app('user_role')->name }}</p></span>
                                                            ...
                                                            <div class="notification-avatar">
                                                                <div class="avatar avatar-2xl me-3">
                                                                    <img class="rounded-circle"
                                                                        src="/assets/admin/img/team/1-thumb.png"
                                                                        alt="">
                                                                </div>
                                                            </div>
            ...
            <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button"
                    ...
                    <div class="avatar avatar-xl">
                        <img class="rounded-circle" src="/assets/admin/img/team/avatar.png" alt="" />
                    </div>
                </a>
    ...
    <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand-lg" style="display: none;"
        ...
        <a class="navbar-brand me-1 me-sm-3" href="{{ route('dashboard') }}">
            <div class="d-flex align-items-center"><img class="me-2"
                    src="/assets/admin/img/icons/spot-illustrations/logo.jpg" alt="" width="40" /><span
