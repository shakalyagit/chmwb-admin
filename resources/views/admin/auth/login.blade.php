...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link href="/assets/admin/vendors/simplebar/simplebar.min.css">
    <link href="/assets/admin/css/theme-rtl.min.css" rel="stylesheet">
    <link href="/assets/admin/css/theme.min.css" rel="stylesheet">
    <link href="/assets/admin/css/user-rtl.min.css" rel="stylesheet">
    <link href="/assets/admin/css/user.min.css" rel="stylesheet">
</head>
        ...
        <div class="container-fluid">
            ...
            <div class="row min-vh-100 bg-100">
                <div class="col-6 d-none d-lg-block position-relative">
                    <div class="bg-holder"
                        style="background-image:url(/assets/admin/img/generic/14.jpg);background-position: 50% 20%;">
                    </div>
                </div>
                        ...
                        <div class="col-lg-9 col-xl-8 col-xxl-6">
                            ...
                            <div class="text-center">
                                <a href="" class="text-center p-4">
                                    <img class="text-center" src="/assets/images/logo.png" alt=""
                                        style="border-radius: 10px; height: 100px">
                                </a>
                                <h3 class="mt-3 mb-5">Council of Homoeopathic Medicine</h3>
                            </div>
